{ config, ... }: {
  home.file."apps/obsidian/main/.obsidian/themes/Adwaita/theme.css".text = ''
    ...
    */
    ...
    body {
      ...
      --background-secondary: ${config.theme.colors.surfaceContainer};
      ...
      --status-bar-background: ${config.theme.colors.surface};
      ...
      body.theme-dark {
        --adwaita-accent-color: ${config.theme.colors.primary};
        --adwaita-accent-bg-color: ${config.theme.colors.primary};
        --adwaita-accent-fg-color: ${config.theme.colors.onPrimary};
        --adwaita-destructive-color: ${config.theme.colors.error};
        --adwaita-destructive-bg-color: ${config.theme.colors.errorContainer};
        --adwaita-destructive-fg-color: ${config.theme.colors.onError};
        ...
        --adwaita-error-color: ${config.theme.colors.error};
        --adwaita-error-bg-color: ${config.theme.colors.errorContainer};
        --adwaita-error-fg-color: ${config.theme.colors.onError};
        --adwaita-window-bg-color: ${config.theme.colors.surface};
        --adwaita-window-fg-color: ${config.theme.colors.onSurface};
        --adwaita-view-bg-color: ${config.theme.colors.surface};
        --adwaita-view-fg-color: ${config.theme.colors.onSurface};
